      ...
      <div>
        <div class="mx-auto max-w-7xl px-4">
          <div class="flex flex-col space-y-8 pb-10 pt-12 md:pt-24">
            <div class="max-w-max rounded-full border  p-1 px-3">
          ...
          <div class="my-8 flex flex-col gap-y-6 md:flex-row lg:justify-around">
            <div class="flex flex-col space-y-3 md:w-2/4 lg:w-1/5">
              ...
              <p class="w-full text-xl font-semibold text-white/900">
                Bengaluru office
              </p>
              <p class="w-full text-base text-white/900">Mon-Sat 9am to 5pm.</p>
          ...
          <div class="mt-16 flex items-center">
            <div class="space-y-6 md:w-3/4">
              ...
              <p class="text-3xl font-bold text-white/900 md:text-4xl">
                Meet our team
              </p>
          ...
          <div class="grid grid-cols-1 gap-4 gap-y-6 border-b border-gray-300 py-12 pb-20 md:grid-cols-2 lg:grid-cols-4">
            <div class="rounded-md border">
              ...
              />
              <p class="mt-6 w-full px-2 text-xl font-semibold text-white/900">
                Gabrielle Fernandez
              </p>
